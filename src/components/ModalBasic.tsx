  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="bg-white light:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
        >
          {/* Modal header */}
          <div className="px-5 py-3 border-b border-slate-200 dark:border-slate-700">
            <div className="flex justify-between items-center">
              <div className="font-semibold text-slate-800 light:text-slate-100">
                {title}
              </div>
              <button
